                ...
                <div class="row position-relative">
                    <div class="col-lg-3 position-sticky" style="position: sticky; position: -webkit-sticky;top: 0;">
                        ...
                        <div class="shop-product-fillter-header">
                            <div class="row">
                                <div class="col-lg-12 col-md-4 col-3 my-2 mb-lg-0 mb-md-5 mb-sm-5">
                                ...
                                <div class="col-lg-12 col-md-4 col-3 my-2 mb-lg-0 mb-md-5 mb-sm-5" id="subCategoryId">
                    ...
                    <div class="col-lg-9">
                        <div class="row product-grid-3" id="filterProducts">
                            @foreach($products as $key => $product)
                                <div class="col-lg-4 col-md-4 col-6 mb-2 g-4" style="border-radius: 20px; gap: 10px">
