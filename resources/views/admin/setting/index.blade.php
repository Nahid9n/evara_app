                                ...
                                <div class="tab-menu-heading border br-5 me-3 my-2">
                                    <div class="tabs-menu">
                                        <ul class="nav panel-tabs flex-column">
                                            ...
                                            <li><a href="#tab2" class="text-default vertical-tabs mb-2" data-bs-toggle="tab"> Manage Purchase Guide</a></li>
                                            <li><a href="#tab3" class="text-default vertical-tabs mb-2" data-bs-toggle="tab"> Manage Shipping Policy</a></li>
