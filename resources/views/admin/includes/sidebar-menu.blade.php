    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{ route('dashboard') }}">
                ...
                <img src="{{asset($setting->logo_jpg)}}" class="header-brand-img toggle-logo" alt="logo">
                <img src="{{asset($setting->logo_jpg)}}" class="header-brand-img light-logo" alt="logo">
                <img src="{{asset($setting->logo_jpg)}}" class="header-brand-img light-logo1" alt="logo">
                @else
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                @if(Session::get('vendor_id'))
                    <li class="slide">
                        <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('vendor.dashboard') }}">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <span class="side-menu__label">Profile Module</span><i class="angle fa fa-angle-right"></i>
                        </a>
                        <ul class="slide-menu">
                            <li class="side-menu-label1"><a href="javascript:void(0)">Profile Module</a></li>
                            <li><a href="{{route('vendor.profile')}}" class="slide-item">Update Profile</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a href="{{ route('vendor-product.create') }}" class="slide-item">Add Product</a></li>
                            <li><a href="{{ route('vendor-product.index') }}" class="slide-item">Manage Product</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a href="{{ route('category.create') }}" class="slide-item">New Order</a></li>
                            <li><a href="{{ route('category.create') }}" class="slide-item">Manage Order</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M21.5,21h-19C2.223877,21,2,21.223877,2,21.5S2.223877,22,2.5,22h19c0.276123,0,0.5-0.223877,0.5-0.5S21.776123,21,21.5,21z M4.5,18.0888672h5c0.1326294,0,0.2597656-0.0527344,0.3534546-0.1465454l10-10c0.000061,0,0.0001221-0.000061,0.0001831-0.0001221c0.1951294-0.1952515,0.1950684-0.5117188-0.0001831-0.7068481l-5-5c0-0.000061-0.000061-0.0001221-0.0001221-0.0001221c-0.1951904-0.1951904-0.5117188-0.1951294-0.7068481,0.0001221l-10,10C4.0526733,12.3291016,4,12.4562378,4,12.5888672v5c0,0.0001831,0,0.0003662,0,0.0005493C4.0001831,17.8654175,4.223999,18.0890503,4.5,18.0888672z M14.5,3.2958984l4.2930298,4.2929688l-2.121582,2.121582l-4.2926025-4.293396L14.5,3.2958984z M5,12.7958984l6.671814-6.671814l4.2926025,4.293396l-6.6713867,6.6713867H5V12.7958984z"/></svg>
                            <span class="side-menu__label">Account Module</span><i class="angle fa fa-angle-right"></i>
                        </a>
                        <ul class="slide-menu">
                            <li class="side-menu-label1"><a href="javascript:void(0)">Forms</a></li>
                            <li><a href="{{ route('category.create') }}" class="slide-item">Manage Account</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" enable-background="new 0 0 24 24" viewBox="0 0 24 24"><path d="M21.5,21h-19C2.223877,21,2,21.223877,2,21.5S2.223877,22,2.5,22h19c0.276123,0,0.5-0.223877,0.5-0.5S21.776123,21,21.5,21z M4.5,18.0888672h5c0.1326294,0,0.2597656-0.0527344,0.3534546-0.1465454l10-10c0.000061,0,0.0001221-0.000061,0.0001831-0.0001221c0.1951294-0.1952515,0.1950684-0.5117188-0.0001831-0.7068481l-5-5c0-0.000061-0.000061-0.0001221-0.0001221-0.0001221c-0.1951904-0.1951904-0.5117188-0.1951294-0.7068481,0.0001221l-10,10C4.0526733,12.3291016,4,12.4562378,4,12.5888672v5c0,0.0001831,0,0.0003662,0,0.0005493C4.0001831,17.8654175,4.223999,18.0890503,4.5,18.0888672z M14.5,3.2958984l4.2930298,4.2929688l-2.121582,2.121582l-4.2926025-4.293396L14.5,3.2958984z M5,12.7958984l6.671814-6.671814l4.2926025,4.293396l-6.6713867,6.6713867H5V12.7958984z"/></svg>
                            <span class="side-menu__label">Change Password</span><i class="angle fa fa-angle-right"></i>
                        </a>
                        <ul class="slide-menu">
                            <li class="side-menu-label1"><a href="javascript:void(0)">Forms</a></li>
                            <li><a href="{{ route('category.create') }}" class="slide-item">Change Password</a></li>
                        </ul>
                    </li>
                @else
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li class="sub-slide">
                                ...
                                <ul class="sub-slide-menu">
                                    ...
                                    <li><a href="{{ route('product_offer.index') }}" class="sub-slide-item">Manage Product Offer</a></li>
                                </ul>
                            </li>
                            <li><a href="{{ route('category.index') }}" class="slide-item"> Categories</a></li>
                            <li><a href="{{ route('sub-category.index') }}" class="slide-item"> Sub Categories</a></li>
                            <li><a href="{{ route('brand.index') }}" class="slide-item"> Brands</a></li>
                            <li><a href="{{ route('unit.index') }}" class="slide-item"> Units</a></li>
                            <li><a href="{{ route('color.index') }}" class="slide-item"> Colors</a></li>
                            <li><a href="{{ route('size.index') }}" class="slide-item"> Sizes</a></li>
                            <li><a href="{{ route('admin.highlight.manage') }}" class="slide-item"> Highlights</a></li>
                            <li><a href="{{ route('admin.tag.manage') }}" class="slide-item"> Tags</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a href="#{{--{{ route('order.index') }}--}}" class="slide-item">New Order</a></li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            ...
                            <li><a href="{{ route('ad.create') }}" class="slide-item">Add Ad</a></li>
                            <li><a href="{{ route('ad.index') }}" class="slide-item">Manage Ad</a></li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
{{--                            <li><a href="" class="slide-item">Subscribers</a></li>--}}
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            <i class="fa fa-gears side-menu__icon"></i>
                            <span class="side-menu__label">Support</span><i class="angle fa fa-angle-right"></i>
                        </a>
                        <ul class="slide-menu">
                            <li><a href="{{route('admin.ticket.manage')}}" class="slide-item">Tickets</a></li>
                            <li><a href="#" class="slide-item">Product conversion</a></li>
                            <li><a href="#" class="slide-item">Product Queries</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            <i class="fa fa-gears side-menu__icon"></i>
                            <span class="side-menu__label">Feature Module</span><i class="angle fa fa-angle-right"></i>
                        </a>
                        <ul class="slide-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            <i class="fa fa-gears side-menu__icon"></i>
                            <span class="side-menu__label">Website CMS</span><i class="angle fa fa-angle-right"></i>
                        </a>
                        <ul class="slide-menu">
                            <li class="side-menu-label1"><a href="javascript:void(0)">Advanced UI</a></li>
                            <li><a href="{{ route('admin.configure.index') }}" class="slide-item">Configuration</a></li>
                            <li><a href="{{ route('admin.popup.index') }}" class="slide-item">Popup</a></li>
                            <li><a href="{{ route('admin.news.index') }}" class="slide-item">News Header</a></li>
                            <li><a href="{{ route('admin.banner.index') }}" class="slide-item">Banner</a></li>
                            <li><a href="#{{--{{ route('admin.news.index') }}--}}" class="slide-item">Testimonial Review</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <ul class="slide-menu">
                            <li class="side-menu-label1"><a href="javascript:void(0)">Advanced UI</a></li>
                            <li><a href="#" class="slide-item">Sales Report</a></li>
                            <li><a href="#" class="slide-item">Inventory Report</a></li>
                            <li><a href="#" class="slide-item">Account Payable Report</a></li>
                            <li><a href="#" class="slide-item">Stock In Report</a></li>
                            <li><a href="#" class="slide-item">Stock Out Report</a></li>
                            <li><a href="#" class="slide-item">Purchase Order Report</a></li>
                            <li><a href="#" class="slide-item">Order Return Report</a></li>
                            <li><a href="#" class="slide-item">PO Return Report</a></li>
                            <li><a href="#" class="slide-item">Order Exchange Report</a></li>
                            <li><a href="#" class="slide-item">PO Exchange Report</a></li>
                        </ul>
                    </li>
                    <li class="slide">
                        <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            <i class="fa fa-bank side-menu__icon"></i>
                            <span class="side-menu__label">Accounting</span><i class="angle fa fa-angle-right"></i>
                        </a>
                        <ul class="slide-menu">
                            <li class="side-menu-label1"><a href="javascript:void(0)">Advanced UI</a></li>
                            <li><a href="#" class="slide-item">Vat Report</a></li>
                            <li><a href="#" class="slide-item">Payment Type Report</a></li>
                            <li><a href="#" class="slide-item">Damage Cost Type</a></li>
                            <li><a href="#" class="slide-item">Damage Cost</a></li>
                            <li><a href="#" class="slide-item">Expense Type</a></li>
                            <li><a href="#" class="slide-item">Expense</a></li>
                            <li><a href="#" class="slide-item">Expense Report</a></li>
                            <li><a href="#" class="slide-item">Order Wise Profit Report</a></li>
                            <li><a href="#" class="slide-item">Product Wise Profit Report</a></li>
                            <li><a href="#" class="slide-item">Brand Wise Profit Report</a></li>
                            <li><a href="#" class="slide-item">Inflow Type</a></li>
                            <li><a href="#" class="slide-item">Inflow</a></li>
                            <li><a href="#" class="slide-item">Opening Balance</a></li>
                            <li><a href="#" class="slide-item">Balance Sheet Report</a></li>
                        </ul>
                    </li>
                    @if(Auth::user()->role == 0)
                        <li class="slide">
